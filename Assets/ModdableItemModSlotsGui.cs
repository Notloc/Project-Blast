...
public class ModdableItemModSlotsGui : MonoBehaviour
{
    ...
    public void SetModdableItem(ModdableItemInstance moddableItem, ModdableItemInstance topLevelModdableItem, IContainer container, UnityAction<ItemModSlotInstance> onModAdded, UnityAction<ItemModSlotInstance, ItemInstance> onModRemoved)
    {
        Clear();
        ...
        foreach (ItemModSlotInstance modSlot in moddableItem.ModSlots)
        {
            ...
            modSlotGui.Initialize(modSlot, topLevelModdableItem, container, onModAdded, onModRemoved);
