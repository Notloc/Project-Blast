...
namespace ProjectBlast.Items.Containers
{
    ...
    public struct ContainerItemEntry
    {
        ...
        public ContainerItemEntry(ItemInstance item, IContainer container, Vector2Int coordinates, bool isRotated = false)
        {
            this.item = item;
        ...
        public ContainerItemEntry(ContainerItemEntry other, bool isRotated)
        {
