...
public class ModdableItemInspectGui : GenericItemInspectGui
{
    ...
    private ItemInstance topLevelModdableItem;
    ...
    public override void SetItem(ItemInstance item, IContainer container)
    {
        ...
        topLevelModdableItem = item.GetTopLevelParent();
        CreateModdableItemSlotsGui((ModdableItemInstance)item, topLevelModdableItem);
    }

    private void CreateModdableItemSlotsGui(ModdableItemInstance moddableItem, ItemInstance topLevelItem)
    {
        ...
        if (moddableItem != null && moddableItem.ModdableItemBase.ModSlots.Count > 0)
        {
            ...
            modSlotsGui.SetModdableItem(moddableItem, topLevelItem, container, OnModAdded, OnModRemoved);
        ...
        foreach (ItemModSlotInstance data in moddableItem.ModSlots)
        {
            ...
            {
                CreateModdableItemSlotsGui((ModdableItemInstance)data.Mod, topLevelItem);
            }
        }
    }
